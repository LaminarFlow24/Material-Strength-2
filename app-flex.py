...
st.title("Flexural Strength Prediction App")
...
if st.button("Predict Flexural Strength"):
    ...
    # Add a dummy column for flexural_str to match the scaler's original shape
    input_combined['flexural_str'] = 0
    ...
    st.success(f"Predicted Flexural Strength: {pred_original[0,0]:.2f}")
